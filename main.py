...
class KulBot:
    def __init__(self, api_id, api_hash, bit_namo, bot_keyi):
        self.boys = []
        self.girls = []
        self.chat_pair = {}

        self.api_id, self.api_hash, self.bit_namo, self.bot_keyi = api_id, api_hash, bit_namo, bot_keyi
